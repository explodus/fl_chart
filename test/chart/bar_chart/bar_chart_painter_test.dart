...
void main() {
  ...
  group('calculateGroupsX test', () {
    ...
    test('test center', () {
      ...
      final xValues =
          painter.calculateGroupsX(size, barGroups, BarChartAlignment.center);
      expect(xValues, [
        closeTo(180, delta),
        closeTo(400, delta),
        closeTo(620, delta),
    ...
    test('test spaceAround', () {
      ...
      final xValues = painter.calculateGroupsX(
          size, barGroups, BarChartAlignment.spaceAround);
      expect(xValues, [
    ...
    test('test start', () {
      ...
      final xValues =
          painter.calculateGroupsX(size, barGroups, BarChartAlignment.start);
      expect(xValues, [
        closeTo(98.5, delta),
        closeTo(295.5, delta),
        closeTo(492.5, delta),
  ...
  test('calculateGroupAndBarsPosition test', () {
    ...
    final groupXValues =
        painter.calculateGroupsX(size, barGroups, BarChartAlignment.center);
    final groupBarsXValues =
        painter.calculateGroupAndBarsPosition(size, groupXValues, barGroups);
